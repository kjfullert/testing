...
spawn_spline_rounded_rectangle_from_center(qlabs, deviceNumber=1, centerLocation=[5.35, 2.5, 0.005], rotation=[0,0,0], cornerRadius=6, xWidth=16.5, yLength=15.8, lineWidth=4, color=pinkLineColor)
spawn_spline_rounded_rectangle_from_center(qlabs, deviceNumber=2, centerLocation=[5.35, 2.5, 0.005], rotation=[0,0,0], cornerRadius=6.25, xWidth=16.5+0.5, yLength=15.8+0.5, lineWidth=4, color=yellowLineColor)
